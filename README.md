...
- Provides an install-time feature option to add NodeTie to Windows Startup Apps for the current user.
- Shows a finish-page checkbox to launch NodeTie immediately after setup.
